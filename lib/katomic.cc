...
void
katomiclist_init(InkAtomicList *l, const char *name, uint32_t offset_to_next)
{
    l->name   = name;
...
void *
katomiclist_pop(InkAtomicList *l)
{
    head_p item;
    head_p next;
    int result = 0;
...
void *
katomiclist_popall(InkAtomicList *l)
{
    head_p item;
    head_p next;
    int result = 0;
...
void *
katomiclist_push(InkAtomicList *l, void *item)
{
...
void *
katomiclist_remove(InkAtomicList *l, void *item)
{
    head_p head;
    void *prev       = nullptr;
